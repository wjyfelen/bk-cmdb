...
// GenerateTableAuditLog generate audit of model attribute,
...
func (h *objectAttributeAuditLog) GenerateTableAuditLog(parameter *generateAuditCommonParameter, objID string, bizID,
	...
	if data == nil {
		...
		rsp, err := h.clientSet.Model().ReadModelAttrByConditionForWeb(kit.Ctx, kit.Header, bizID,
	...
	blog.Errorf("00000000000 data: %+v, objectID: %v", *data, data.ObjectID)
